"""Bouncing DVD Logo program, originally by Al Sweigart
A bouncing dvd logo animation. You have to be of a certain age to
appreciate this. Press Ctrl-C to stop.

Note: Do not  resize the terminal window while this program is running.
View this  code at https://nostartch.com/big-book-small-python-prjects
...
NUMBER_OF_LOGOS = random.randint(1, 100)
PAUSE_AMOUNT = random.randint(1, 10)/100
...
def main():
    ...
    while True:  # main program loop
        for logo in logos:  # handle each logo in the logos list
            ...
            print('    ', end='')  # This clears the logo at its last
            # location before it is reprinted in its new location.
